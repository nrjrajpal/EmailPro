...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="navigation fixed grid grid-cols-[70%_30%] lg:grid-cols-[30%_40%_30%] h-20 w-full max-w-screen-2xl z-10 navbar-effect pb-2 items-center">
      ...
      >
        ...
        >
          <button onClick={toggleMenu} className="absolute top-4 right-4 text-black" aria-label="Close menu">
            <svg
