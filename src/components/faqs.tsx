...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes, we provide 24/7 customer support through email and live chat for all our customers.",
  },
];
...
export default function FAQs() {
  ...
  return (
    <>
      <div className="w-[150%] md:w-[100dvw]">
        <Wave />
      </div>
      <div
        id="faqs"
            ...
            <div
              ...
              className={`rounded-lg transition-all duration-300 ease-in-out overflow-hidden
                ${
                  expandedId === faq.id
                    ? "bg-[#E4DED3]"
                    : "border-2 border-[#555555] hover:bg-[#222222]"
                }`}
            >
              <button
              ...
              >
                <div className="overflow-hidden">
                  <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-0 text-gray-800 text-base">
                    {faq.answer}
                  </div>
                </div>
              </div>
